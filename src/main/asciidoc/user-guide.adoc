...
You can specify an SQL in annotation using "link:https://openjdk.java.net/jeps/355[Text Blocks^]link:https://openjdk.java.net/jeps/355[Text Blocks^]" feature that support by future JDK version.
